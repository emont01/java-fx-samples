...
/**
 * Created by Eivar Montenegro on 09/28/16.
 *
...
public class ColorfulCircles extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Rectangle colors = rectangles(root, scene);
        Group circles = circles(root);
    ...
    private Rectangle rectangles(Group root, Scene scene) {
    ...
    private Group circles(Group root) {
    ...
    private void animation(Group circles) {
